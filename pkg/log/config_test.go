...
func TestOverrides(t *testing.T) {
	...
	} else if s.OutputLevel() != InfoLevel {
		t.Errorf("Expecting InfoLevel, got %v", s.OutputLevel())
	}
	...
	if err := Configure(o); err != nil {
		t.Errorf("Expecting success, got %v", err)
	} else if s.StackTraceLevel() != InfoLevel {
		t.Errorf("Expecting InfoLevel, got %v", s.StackTraceLevel())
	}
...
func TestCapture(t *testing.T) {
	lines, _ := captureStdout(func() {
		...
		// all these  thrown out since the level is set to none
